...
class OldMainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final mainTextStyle =
        GoogleFonts.getFont('Noto Sans', fontSize: 56.0, color: Colors.black);
    final mainTextStyleBold =
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(
                  curScreenWidth / 4.5, 8.0, curScreenWidth / 4.5, 8.0),
              child: Row(
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            width: (curScreenWidth - curScreenWidth / 4.5 * 2) *
                                0.3,
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('한국 대함 레이더 모의 시뮬레이터 프로그램 개발',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 24.0)),
                                ...
                                Text('Description.',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 16.0)),
                                Text(
                                    '한국 K-SSRS(Korean Surface Search Radar System을 모의하는 시뮬레이터를 개발하는 프로젝트.'),
                                Text('What I did.',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 16.0)),
                                ...
                                Text(
                                    '* 실제 K-SSRS 장비와 외부장치와 중간 연동을 시켜주는 신호연동부 장치 SBC장치 개발'),
                                Text('Tech Stack.',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 16.0)),
                                Text(
                                    'VxWorks(C), PCIe 인터페이스, VME,  MFC(C++), OpenGL, FTP, '),
                              ],
                            ),
                          ),
                          Container(
                            ...
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('무인수색 통신단말기 제어 시뮬레이터 프로그램 개발',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 24.0)),
                                ...
                                Text('Description.',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 16.0)),
                                Text(
                                    '무선 통신단말기를 제어 하는 통제차량 및 무인차량을 모의하는 프로그램 개발'),
                                Text('What I did.',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 16.0)),
                                ...
                                Text(
                                    '* GPS 장치를 이용하여 실시간 위치를 송신 및 수신 하여 화면에 실시간 위치 전시'),
                                Text(
                                    '* 통신단말기 성능 측정을 위하여 PTP 타임서버를 이용하여 장비 성능 측정'),
                                Text('* UDP/TCP 또한 Multicast를 이용한 데이터 송수신 구현'),
                                Text('Tech Stack.',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 16.0)),
                                Text(
                                    'MFC(C++), OpenGL, gstreamer, OpenSSL, 시리얼통신(GPS),네트워크 소켓 통신(UDP/TCP), PTP타임서버'),
                              ],
                            ),
                          ),
                          Container(
                              ...
                              children: [
                                ...
                                Text('Description.',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 16.0)),
                                Text(
                                    '한국 해군 DDH1, DDH2 구축함의 비디오 영상 및 레이더 데이터를 저장 하는 장치 개발'),
                                Text('What I did.',
                                    style: mainTextStyleBold.copyWith(
                                        fontSize: 16.0)),
